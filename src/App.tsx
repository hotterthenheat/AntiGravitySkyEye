        ...
        <div className="flex items-center gap-4 text-[9.5px]">
          {session?.authenticated ? (
            ...
            <div className="flex items-center gap-2">
              <span className="text-zinc-600 block uppercase font-black text-[8.5px] mr-2">SECURE OAUTH ACCESS:</span>
              <a 
                href="/api/auth/google" 
                className="px-2.5 py-1 border border-zinc-900 hover:border-zinc-800 bg-zinc-950 text-zinc-400 hover:text-white uppercase font-black transition-colors flex items-center gap-1"
              >
